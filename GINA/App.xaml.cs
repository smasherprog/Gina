...
namespace GimaSoft.GINA
{
    ...
    public partial class App : global::System.Windows.Application, ISingleInstanceApp
    {
        ...
        private void WriteException(StreamWriter stream, Exception ex)
        {
            ...
            {
                WriteException(stream, ex.InnerException);
            }
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            AppDomain.CurrentDomain.UnhandledException += delegate (object sender, UnhandledExceptionEventArgs args)
            {
                try
                {
                    ...
                    {
                        var streamWriter = File.CreateText(Configuration.CrashLogFilePre);
        ...
        public GINAData Data => GINAData.Current;

        // Token: 0x17000165 RID: 357
        // (get) Token: 0x060003C3 RID: 963 RVA: 0x0000D0B1 File Offset: 0x0000B2B1
        public Configuration Configuration => Configuration.Current;
        ...
        private static readonly string Unique = "Gimagukk_GINA_Application" + global::System.Windows.Forms.Application.ProductVersion;
    }
}
