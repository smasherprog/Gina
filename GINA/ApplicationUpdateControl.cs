...
namespace GimaSoft.GINA
{
	...
	public class ApplicationUpdateControl : BindableControl
	{
		...
		public string Message
		{
			get
			{
				return base.Get<string>("Message");
			}
			set
			{
				base.Set("Message", value);
			}
		}
		...
		public bool UseAutoMode
		{
			get
			{
				return (bool)base.GetValue(ApplicationUpdateControl.UseAutoModeProperty);
			}
			set
			{
				base.SetValue(ApplicationUpdateControl.UseAutoModeProperty, value);
			}
		}
		...
		public string CurrentVersion
		{
			get
			{
				return base.Get<string>("CurrentVersion");
			}
			set
			{
				base.Set("CurrentVersion", value);
			}
		}
		...
		public string NewVersion
		{
			get
			{
				return base.Get<string>("NewVersion");
			}
			set
			{
				base.Set("NewVersion", value);
			}
		}
		...
		private void CheckUpdate()
		{
			...
			ApplicationDeployment.CurrentDeployment.CheckForUpdateCompleted += delegate(object o, CheckForUpdateCompletedEventArgs e)
			{
				...
				this.NewVersion = e.AvailableVersion.ToString();
				this.CurrentVersion = ApplicationDeployment.CurrentDeployment.CurrentVersion.ToString();
				this.Status = 4;
			};
		...
		public GenericCommand DownloadCommand
		{
			get
			{
				return new GenericCommand(delegate(object p)
		...
		public GenericCommand OpenChangeLogCommand
		{
			get
			{
				return new GenericCommand(delegate(object p)
				{
					Process.Start(Configuration.GINAChangeLogURL);
				});
			}
		}
